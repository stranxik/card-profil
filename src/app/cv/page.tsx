      ...
      <div className="max-w-3xl mx-auto space-y-8 py-16">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4 text-caption">
            <a href="mailto:thibaultnoelsouris@gmail.com" className="inline-flex items-center gap-2 hover:text-white">
              <Mail className="w-4 h-4" />
              thibaultnoelsouris@gmail.com
            </a>
          ...
          <Card className="border-neutral-800 bg-black">
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-neutral-400 text-sm">Jan 2022 - Present</span>
              </div>
          ...
          <Card className="border-neutral-800 bg-black">
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-neutral-400 text-sm">Jul 2023 - Apr 2024</span>
              </div>
              <ul className="text-neutral-300 space-y-2 list-disc list-inside">
          ...
          <Card className="border-neutral-800 bg-black">
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-neutral-400 text-sm">Nov 2022 - Jan 2024</span>
              </div>
              <ul className="text-neutral-300 space-y-2 list-disc list-inside">
          ...
          <Card className="border-neutral-800 bg-black">
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-neutral-400 text-sm">Nov 2022 - Dec 2022</span>
              </div>
              <ul className="text-neutral-300 space-y-2 list-disc list-inside">
          ...
          <Card className="border-neutral-800 bg-black">
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-neutral-400 text-sm">Oct 2021 - Dec 2021</span>
              </div>
              <ul className="text-neutral-300 space-y-2 list-disc list-inside">
          ...
          <Card className="border-neutral-800 bg-black">
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-neutral-400 text-sm">Nov 2018 - Dec 2021</span>
              </div>
              <ul className="text-neutral-300 space-y-2 list-disc list-inside">
          ...
          <Card className="border-neutral-800 bg-black">
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-neutral-400 text-sm">Sep 2017 - Nov 2017</span>
              </div>
              <ul className="text-neutral-300 space-y-2 list-disc list-inside">
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-neutral-300">Agile, Scrum, Kanban, Jira, Notion, Wrike</p>
                </div>
                <div>
                  <h3 className="text-white font-medium mb-2">Automatisation</h3>
                  <p className="text-neutral-300">N8N, Zapier, Make</p>
                </div>
                <div>
                  <h3 className="text-white font-medium mb-2">Développement web</h3>
                  <p className="text-neutral-300">WordPress, JavaScript, Python, PHP, HTML, CSS</p>
                </div>
                <div>
                  <h3 className="text-white font-medium mb-2">IA & LLM</h3>
                  <p className="text-neutral-300">Langchain, RAG Builder, GPT-4</p>
                </div>
                <div>
                  <h3 className="text-white font-medium mb-2">Bases de données</h3>
                  <p className="text-neutral-300">Supabase, PostgreSQL</p>
                </div>
                <div>
                  <h3 className="text-white font-medium mb-2">Analytics</h3>
                  <p className="text-neutral-300">Google Analytics, SEMrush</p>
                </div>
              </div>
            </CardContent>
          </Card>
